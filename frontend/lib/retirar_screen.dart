...
// Definimos un StatefulWidget para manejar un estado dinámico en la pantalla de retiros
...
// Clase que contiene el estado y la lógica de WithdrawalsScreen
class _WithdrawalsScreenState extends State<WithdrawalsScreen> {
  // Variable para manejar el índice seleccionado en la barra de navegación inferior (2 para "Retiros")
  ...
  // Variable para controlar el estado de carga durante el procesamiento del retiro
  bool _isLoading = false;

  // Variable para almacenar el ID del usuario, obtenido de los argumentos de la ruta
  int? userId;

  // Lista de valores predefinidos para los botones de retiro rápido
  ...
  Future<void> _processWithdrawal() async {
    ...
    try {
      ...
      print('Monto a retirar: $amount'); // Log para depuración
    } catch (e) {
    ...
    // Cambiamos el estado para indicar que se está procesando el retiro
    setState(() {
      _isLoading = true; // Mostramos un indicador de carga
    });

    try {
      // Llamamos al método retirarSaldo de ApiService para realizar el retiro
      ...
      if (result.contains('exitoso') || !result.contains('Error')) {
        // Mostramos un diálogo para confirmar que el retiro fue exitoso
        showDialog(
          context: context,
          barrierDismissible:
              false, // El usuario debe usar un botón para cerrar
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              actions: [
                // Botón para realizar otro retiro
                TextButton(
                  onPressed: () {
      ...
      body: FadeIn(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Tarjeta principal para el formulario de retiro
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        controller:
                            _amountController, // Vinculamos el controlador
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed:
                              _isLoading
                                  ? null
                                  : _processWithdrawal, // Desactivamos si está cargando
                          style: ElevatedButton.styleFrom(
                  ...
                  child: GridView.builder(
                    gridDelegate:
                        const SliverGridDelegateWithFixedCrossAxisCount(
                          ...
                          crossAxisSpacing:
                              10, // Espacio horizontal entre botones
        ...
        onTap: (index) {
          ...
          if (index != _selectedIndex) {
            if (index == 0) {
              ...
              // Navegamos a la pantalla de transferencias (depósitos)
              Navigator.pushReplacementNamed(
                context,
                '/transfers',
                arguments: userId, // Pasamos el userId
            ...
            // No hacemos nada si el índice es 2 porque ya estamos en esta pantalla
          }
        },
        items: const [
